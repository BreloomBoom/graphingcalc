...
exp = input("What is your equation? ")
equation = exp.replace(")(", ")*(").replace("^", "**").split(" = ")
...
x_axis.color("white")
x_axis.goto(0, 0)
x_axis.shapesize(stretch_wid = 0.1, stretch_len = 160)
...
y_axis.color("white")
y_axis.goto(0, 0)
y_axis.shapesize(stretch_wid = 120, stretch_len = 0.1)
